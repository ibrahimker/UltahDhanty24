$('.start').click(function(){
    $('.stage1').fadeOut();
    fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/cake_modal.png','Ayo Buat Kue!','Selamat ulang tahun sayang. Biar fresh from the oven, kuenya harus dibuat dulu nih :D Klik tombol untuk mulai bikin kuenya');
})
...
$('.mixer').click(function(){
    ...
    if(mixtimes == 6){
        $('.stage2').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/mix_modal.png','Sukses mengaduk!','Selamat, adonan kita sudah sempurna. Sekarang saatnya masukan kue kita ke dalam oven, karena ini oven super keren, 3 detik saja sudah cukup untuk memanggang kue kita :D');
...
$( ".oven" ).droppable({
    drop: function( event, ui ) {
        $('.stage3').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/oven_modal.png','Memanggang Berhasil!','Yeah! Kamu jago sekali, sekarang kue kita sudah matang. Ayo kita berkreasi dan tambahkan warna dan rasa ke dalam kue kita');
    }
})
...
$('.sa2').click(function(){
    fire_modal('https://i.ebayimg.com/images/g/FNUAAOSw6mJanxIg/s-l300.jpg','Citizen EM-0403','Selamaaat kamu berhak mendapatkan jam tangan citizen em-0403 :!!!! Kabar buruknya, jamnya masih dijalan karena pengirimannya jauh haha jadi dilampirkan tracking nya aja yaa <iframe width ="400px" src="https://dutyfreeisland.aftership.com/LP012432357HK"></iframe>');
})